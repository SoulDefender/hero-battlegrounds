...
@Component
public class AjaxAwareAuthSuccessHandler implements AuthenticationSuccessHandler {

    private final ObjectMapper mapper;
    private final JwtTokenFactory tokenFactory;


    public AjaxAwareAuthSuccessHandler(final ObjectMapper mapper, final JwtTokenFactory tokenFactory) {
